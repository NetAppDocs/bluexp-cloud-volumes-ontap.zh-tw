...
本頁所述的增強功能僅適用於支援Cloud Volumes ONTAP 支援管理功能的BlueXP功能。若要瞭解Cloud Volumes ONTAP 有關此功能的最新消息、請參閱 https://["前往Cloud Volumes ONTAP 《發行說明》"^]
...
如需詳細資訊、請參閱 link:https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-manage-capacity-licenses.html["管理容量型授權"^]。
...
https://["深入瞭Cloud Volumes ONTAP 解本版的更新功能"^]。
...
https://["瞭解如何使用NetApp加密解決方案來加密磁碟區"^]。
...
* https://["將Connector安裝在沒有網際網路存取的位置"^]
* https://["存取Connector上的BlueXP主控台"^]
* https://["新增未指派的授權"^]
...
https://["瞭解如何在ONTAP 功能區中設定及管理S3物件儲存服務"^]
...
如需有關如何設定及使用NDMP的資訊、請參閱 https://["NDMP組態總覽"]。
...
如需此新功能的詳細資訊、請參閱 https://["設定Cloud Volumes ONTAP 支援使用Azure中客戶管理的金鑰"]。
...
* *邊緣快取*：授權 https://["Cloud Volumes Edge快取"^]
...
https://["檢視Cloud Volumes ONTAP 支援區域的完整清單以供參閱"^]
...
"ec2:ModifyVolume",
----
請務必為您新增至BlueXP的每組AWS認證資料提供這些權限。 https://["檢視AWS的最新Connector原則"^]。
...
https://["深入瞭解Azure Private Link與Cloud Volumes ONTAP NetApp的連線功能"]。
...
* https://["深入瞭解Google Cloud中的儲存VM限制"^]
* https://["瞭解如何在Cloud Volumes ONTAP Google Cloud中建立資料服務儲存VM以供其使用"]
...
https://["瞭解BlueXP中的Kubernetes資料管理"^]
...
https://["在Cloud Volumes ONTAP Google Cloud中檢視支援的支援功能組態"^]
...
您仍可在連線Cloud Volumes ONTAP 至該系統的網頁瀏覽器中輸入叢集管理IP位址、以連線至System Manager。 https://["深入瞭解連線至System Manager"]。
...
https://["深入瞭Cloud Volumes ONTAP 解適用於NetApp的授權選項"]。
...
前往 https://["發行說明 Cloud Volumes ONTAP"^] 如需支援組態的詳細資訊、請參閱。
...
資料會使用在Cloud Volumes ONTAP Azure中的功能自動加密 https://["Azure 儲存服務加密"^] 使用Microsoft管理的金鑰。但您現在可以改為使用客戶管理的加密金鑰、只要完成下列步驟即可：
...
https://["在Cloud Volumes ONTAP AWS中檢視支援的支援組態"^]。
...
----
請務必為您新增至BlueXP的每組Azure認證提供這些權限。 https://["檢視Azure最新的Connector原則"^]。
...
https://["在Cloud Volumes ONTAP GCP中檢視支援的組態"^]。
...
前往 https://["AWS Marketplace頁面"^] 若要檢視價格詳細資料、請前往 https://["發行說明 Cloud Volumes ONTAP"^] 以深入瞭解此授權選項。
...
請注意、Connector需要新的權限才能刪除Azure快照。 https://["檢視Azure最新的Connector原則"^]。
...
當您在單一節點系統上使用 E32s_v3 VM 類型時、可使用 Ultra SSD 做為 VNVRAM Cloud Volumes ONTAP https://["在任何受支援的 Azure 地區"^]。

...
+
https://docs.netapp.com/us-en/snapcenter/get-started/concept_snapcenter_overview.html["深入瞭SnapCenter 解功能"^]
...
https://bluexp.netapp.com/ontap-cloud["深入瞭 Cloud Volumes ONTAP 解功能"^]

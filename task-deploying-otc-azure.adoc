...
+
對於單一節點系統、您可以選擇要部署 Cloud Volumes ONTAP 的可用度區域。如果您未選擇 AZ 、 Cloud Manager 會為您選擇一個。
...
| 可用度區域 | 對於單一節點系統、您可以選擇要部署 Cloud Volumes ONTAP 的可用度區域。如果您未選擇 AZ 、 Cloud Manager 會為您選擇一個。 
...
| 產生的安全性群組  a| 
如果讓Cloud Manager為您產生安全群組、您必須選擇允許流量的方式：

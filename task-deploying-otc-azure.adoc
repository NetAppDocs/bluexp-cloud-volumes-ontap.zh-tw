...
NOTE: 對於中國地區，只有 Cloud Volumes ONTAP 9.12.1 GA 和 9.13.0 GA 支援單一節點部署。您可以將這些版本升級至較新的 Cloud Volumes ONTAP 修補程式和版本。如果您想要在中國地區部署較新的 Cloud Volumes ONTAP 版本，請聯絡 NetApp 支援。這些地區僅支援直接向 NetApp 購買的授權。

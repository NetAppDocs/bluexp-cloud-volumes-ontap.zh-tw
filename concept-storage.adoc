...
* http://["AWS 文件： EBS Volume 類型"^]
* link:task-planning-your-config.html["瞭解如何在 AWS 中為系統選擇磁碟類型和磁碟大小"]
* https://["檢閱 Cloud Volumes ONTAP AWS 的儲存限制"^]
* http://["檢閱 Cloud Volumes ONTAP AWS 支援的支援組態"^]
...
* https://["Microsoft Azure文件：Azure託管磁碟類型"^]
* https://["Microsoft Azure文件：Azure網頁瀏覽總覽"^]
* link:task-planning-your-config-azure.html["瞭解如何在 Azure 中為您的系統選擇磁碟類型和磁碟大小"]
* https://["檢閱 Cloud Volumes ONTAP Azure 的儲存限制"^]
...
* https://["Google Cloud文件：儲存選項"^]
* https://["檢閱Cloud Volumes ONTAP Google Cloud中的功能不均儲存限制"^]

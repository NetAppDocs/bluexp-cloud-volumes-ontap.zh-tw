...
NOTE: 以*高速*寫入速度選項提供_Flash Cache、高速寫入速度和更高的最大傳輸單元（MTU）8、896、以及n2-Standard-16、n2-Standard-32、n2-Standard-48和n2-Standard-64執行個體類型。此外、較高的MTU為8、896時、部署時必須選擇VCP、VPC、2或VCP。_Flash Cache、高速寫入速度和8、896的MTU是功能相依的、無法在設定的執行個體中個別停用。

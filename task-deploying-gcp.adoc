...
NOTE: 這是您為BlueXP設定的服務帳戶、 link:https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-google.html#set-up-a-service-account-for-the-connector["如本頁所述"^]。
...
TIP: 如果您想要使用WORM和資料分層、您必須停用Cloud Backup、並部署Cloud Volumes ONTAP 9.8版或更新版本的運作環境。

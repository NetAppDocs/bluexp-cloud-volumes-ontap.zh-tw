...
NOTE: 這是您為BlueXP設定的服務帳戶、 link:https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-creating-connectors-gcp.html#set-up-a-service-account-for-the-connector["如本頁所述"^]。

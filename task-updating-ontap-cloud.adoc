...
BlueXP 提供三種升級 Cloud Volumes ONTAP 的方法：
...
NOTE: 目前、您只能透過 BlueXP 使用者介面升級至最新的可用 ONTAP 版本。透過 BlueXP 使用者介面升級至特定 ONTAP 版本的功能將在未來版本中提供。
...
+
https://["NetApp KB：如何將BlueXP設定為HTTPS伺服器、以裝載升級映像"^]

...
https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-google.html#shared-vpc-permissions["檢閱Connector部署所涵蓋的必要共享VPC權限"^]
...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-google.html["檢視連接器的網路需求"^]
